# Generated by Django 4.2.11 on 2025-01-23 03:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "associated_task_meeting_id",
                    models.IntegerField(blank=True, null=True),
                ),
                (
                    "response_type",
                    models.CharField(
                        choices=[("Chat", "Chat"), ("Action", "Action")], max_length=50
                    ),
                ),
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                "verbose_name_plural": "Movie Info",
            },
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                default="Singapore", max_length=20, verbose_name="Region"
            ),
        ),
        migrations.AlterField(
            model_name="movie",
        ...
        migrations.AlterField(
            ...
            name="language",
            field=models.CharField(
                default="English", max_length=20, verbose_name="Language"
            ),
        ),
        migrations.CreateModel(
            name="Task",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "report_type",
                    models.CharField(
                        choices=[("Personal", "Personal"), ("Project", "Project")],
                        max_length=50,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "participants",
                    models.ManyToManyField(related_name="meetings", to="webapp.user"),
                ),
            ],
        ),
        migrations.CreateModel(
